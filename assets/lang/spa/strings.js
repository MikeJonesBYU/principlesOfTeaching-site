...
window.TDS_STRINGS = {
  ...
  "graphic": "graphic-spa.svg",

  // ---- index.html ----
  "indexTitle": "Enseñanza al estilo de Cristo — Generador de combinaciones de habilidades",
  "diagramAlt": "Principios de la enseñanza al estilo de Cristo: un anillo exterior con las leyendas «Amar a quienes enseña» y «Enseñar por el Espíritu» rodea tres círculos superpuestos —«Centrarse en Jesucristo», «Enseñar la doctrina» y «Fomentar el aprendizaje diligente»— que se unen en el centro: «La conversión a Jesucristo».",
  ...
  "indexHint": "Elija usted mismo cada habilidad u obtenga un conjunto al azar que puede actualizar cuando quiera.",
